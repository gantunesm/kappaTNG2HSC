...
def kappa_gen(LP, run, iz):
    fname = "/global/cscratch1/sd/jialiu/kappaTNG/kappaTNG-Dark/LP%03d/run%03d/kappa%02d.dat"%(LP, run, iz)
       #kappaTNG-Hydro
...
def mass_product (counter):
       ...
       for zz in range(len(zs)):
              fn = '/global/cscratch1/sd/gmarques/tng/kappaTNG-Dark_HSCzs/'+zs[zz]+'/kappa%i.npy' % (counter)
